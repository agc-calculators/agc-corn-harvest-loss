...
class AgcCornHarvestLoss {
    ...
    render() {
        return (h("div", null,
            h("form", { onSubmit: e => e.preventDefault(), ref: c => (this.form = c), "data-wizard": "agc-corn-harvest-loss", "data-wizard-mode": this.mode, class: "agc-wizard" },
                h("slot", null),
                h("section", { "data-wizard-section": "0" },
                    h("div", { class: "agc-wizard__field" },
                        ...
                        h("p", { "data-i18n": `hints.kernels-counted` }, "\u2BA4 Enter the total number of corn kernels counted on the ground within the specified area.")),
                ...
                h("section", { "data-wizard-section": "1" },
                    h("div", { class: "agc-wizard__field" },
                        ...
                        h("p", { "data-i18n": `hints.loss-area` }, "\u2BA4 Enter the area in square feet that was used to count corn kernels on the ground.")),
    ...
    showResults() {
        ...
        let yieldLoss = round(kernelsCounted / lossArea / 2, 2);
        let results = {
            socket: this.socket,
            tract: this.tract,
            units: this.units,
    ...
    static get is() { return "agc-corn-harvest-loss"; }
