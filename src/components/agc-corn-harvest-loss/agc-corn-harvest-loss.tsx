...
export class AgcCornHarvestLoss {
    ...
    return (
      <div>
        <form
          ...
          data-wizard="agc-corn-harvest-loss"
        ...
        >
          ...
          <section data-wizard-section="0">
            <div class="agc-wizard__field">
              ...
              <p data-i18n={`hints.kernels-counted`}>⮤ Enter the total number of corn kernels counted on the ground within the specified area.</p>
            </div>
          ...
          <section data-wizard-section="1">
            <div class="agc-wizard__field">
              ...
              >
                Please enter a whole number of one or more.
              </p>
              <p data-i18n={`hints.loss-area`}>⮤ Enter the area in square feet that was used to count corn kernels on the ground.</p>
            </div>
            <div class="agc-wizard__actions">
  ...
  showResults() {
    ...
    let lossArea = parseInt((this.form.querySelector(
      '[name="lossArea"'
